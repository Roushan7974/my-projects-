...
class Attendance:
    ...
    def __init__(self,root):
        ...
        # first header image  
        img=Image.open(r"C:\Users\hp\Desktop\Demo\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\banner.jpg")
        ...
        # backgorund image 
        bg1=Image.open(r"C:\Users\hp\Desktop\Demo\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\bg2.jpg")
        ...
        main_frame.place(x=5,y=55,width=1600,height=560)
        ...
        right_frame.place(x=800,y=10,width=660,height=480)
    ...
    def update_data(self):
        if self.var_id.get()=="" or self.var_roll.get=="" or self.var_name.get()=="" or self.var_time.get()=="" or self.var_date.get()=="" or self.var_attend.get()=="Status":
            ...
            try:
                ...
                if Update > 0:
                    conn = mysql.connector.connect(username='root', password='',host='localhost',database='project',port=3306)
